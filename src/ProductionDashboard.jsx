...
const S = {
  ...
  skuMatrixCornerCell: { padding: "10px 12px", textAlign: "left", whiteSpace: "nowrap", minWidth: 76, fontSize: 11, fontWeight: 600, color: "#94A3B8", background: "#F8FAFC", borderRight: "1px solid #E2E8F0", borderBottom: "1px solid #E2E8F0", textTransform: "uppercase", letterSpacing: 0.3 },
  skuMatrixSizeHeader: { padding: "10px 12px", textAlign: "center", fontSize: 12, fontWeight: 700, color: "#0F172A", background: "#F1F5F9", borderBottom: "1px solid #E2E8F0", minWidth: 50 },
  skuMatrixTotalHeader: { padding: "10px 12px", textAlign: "center", fontSize: 11, fontWeight: 700, color: "#0F172A", background: "#0F172A", color: "white", borderBottom: "1px solid #E2E8F0", letterSpacing: 0.3 },
  skuMatrixColorCell: { padding: "16px 12px", textAlign: "left", whiteSpace: "nowrap", minWidth: 76, fontSize: 13, fontWeight: 600, color: "#1F2937", background: "#F8FAFC", borderRight: "1px solid #E2E8F0", borderBottom: "1px solid #F1F5F9" },
  skuMatrixCell: { padding: "16px 12px", textAlign: "right", fontSize: 13, color: "#0369A1", fontWeight: 600, fontVariantNumeric: "tabular-nums", borderBottom: "1px solid #F1F5F9" },
  skuMatrixEmptyCell: { padding: "16px 12px", textAlign: "center", fontSize: 13, color: "#CBD5E1", borderBottom: "1px solid #F1F5F9" },
  skuMatrixRowTotal: { padding: "16px 12px", textAlign: "right", fontSize: 13, fontWeight: 700, color: "#0F172A", background: "#F8FAFC", fontVariantNumeric: "tabular-nums", borderBottom: "1px solid #F1F5F9", borderLeft: "1px solid #E2E8F0" },
  skuMatrixFooterRow: { background: "#F1F5F9" },
  skuMatrixFooterLabel: { padding: "16px 12px", textAlign: "left", whiteSpace: "nowrap", minWidth: 76, fontSize: 12, fontWeight: 700, color: "#475569", background: "#F1F5F9", borderRight: "1px solid #E2E8F0", borderTop: "1px solid #E2E8F0", textTransform: "uppercase", letterSpacing: 0.3 },
  skuMatrixColTotal: { padding: "16px 12px", textAlign: "right", fontSize: 13, fontWeight: 700, color: "#0F172A", background: "#F1F5F9", fontVariantNumeric: "tabular-nums", borderTop: "1px solid #E2E8F0" },
  skuMatrixGrandTotal: { padding: "16px 12px", textAlign: "right", fontSize: 14, fontWeight: 800, color: "white", background: "#0F172A", fontVariantNumeric: "tabular-nums", borderTop: "1px solid #E2E8F0", borderLeft: "1px solid #0F172A" },
